...
public class EasyAlert {
     ...
     */
    @discardableResult
    public func addAction(_ title: String, style: UIAlertAction.Style, handler: actionHandler? = nil) -> EasyAlert {
     ...
     */
    @discardableResult
    internal func addAction(_ title: String, style: UIAlertAction.Style, preferredAction: Bool = false, handler: actionHandler? = nil) -> EasyAlert {
    ...
    @discardableResult
    public func presentIn(_ source: UIViewController) -> EasyAlert {
    ...
    @discardableResult
    public func delay(_ time: TimeInterval) -> EasyAlert {
        delayTime = time
        return self
    }
...
public class ActionSheet: EasyAlert {
